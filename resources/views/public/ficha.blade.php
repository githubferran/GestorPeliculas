...
@section('content') 
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
    <div class="content-row row">
      <div class="col-6">
        <div class="content-box bg-dark me-md-3 pt-3 px-3  px-md-5 text-center text-white overflow-hidden">
            <h2 class="display-5">{{$pelicula->titulo}}</h2>
            <div class=" row">
              <div class="aditional-info-left col-6">
                {{$pelicula->categorias->nombre}}
              </div>
            ...
            <div> 
              <img class="content-portada" src="{{URL::asset('storage/'. $pelicula->portada)}}">
            </div>
        </div>  
      </div>
      <div class=" col-6">
  ...
  <div class="row">
    @foreach($peliculasRelacionadas as $peliculaRelacionada)
      <div class="content-relation-image col-6 col-md">
        <img  width="179" height="235" src="{{URL::asset('storage/'. $peliculaRelacionada->portada)}}">
      </div>
    @endforeach
